Pod::Spec.new do |spec|
    spec.name                  = 'AdMobNetworkAdapter-STAGING'
    spec.version               = '0.5.2'
    spec.license               = { :type => 'CUSTOM', :file => 'LICENSE' }
    spec.homepage              = 'https://stash.miniclip.com/projects/SDK/repos/ulam-ios-admob-adapter/'
    spec.source                = { :http => "https://miniclip.jfrog.io/artifactory/sdk-cocoapods-dev-local/AdMobNetworkAdapter/AdMobNetworkAdapter-#{spec.version}.tar.gz" }
