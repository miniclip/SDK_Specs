Pod::Spec.new do |spec|
    spec.name                  = 'UnityAdsNetworkAdapter-STAGING'
    spec.version               = '0.5.3'
    spec.license               = { :type => 'CUSTOM', :file => 'LICENSE' }
    spec.homepage              = 'https://stash.miniclip.com/projects/SDK/repos/ulam-ios-unitynetworkadapter-adapter/'
    spec.source                = { :http => "https://miniclip.jfrog.io/artifactory/sdk-cocoapods-dev-local/UnityAdsNetworkAdapter/UnityAdsNetworkAdapter-#{spec.version}.tar.gz" }
    ...
    spec.dependency 'ULAM-STAGING', '>= 0.5', '< 0.6'
