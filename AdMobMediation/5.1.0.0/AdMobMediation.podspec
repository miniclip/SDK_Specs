Pod::Spec.new do |spec|
  ...
  spec.version               = '5.1.0.0'
  spec.license               = { :type => 'CUSTOM', :file => 'LICENSE' }
  spec.homepage              = 'https://stash.miniclip.com/projects/SDK/repos/m-ads-ios-admob-mediation/'
  ...
  spec.summary               = 'AdMobMediation for M-Ads iOS software development kit'
